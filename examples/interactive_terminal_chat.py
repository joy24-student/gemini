# -*- coding: utf-8 -*-
"""
examples/interactive_terminal_chat.py
======================================
Interactive Terminal CLI Chat for Google Gemini.

Usage:
  python examples/interactive_terminal_chat.py
  python examples/interactive_terminal_chat.py --auto-cookie
  python examples/interactive_terminal_chat.py --cookies cookies.json
"""
import sys
import os
import io
